...
--51. TIPOS EVIDENCIAS
CREATE TABLE tipos_evidencIaS (
    id_tipo_evidencia       NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
    nombre                  VARCHAR2(50 CHAR) NOT NULL,
    descripcion             VARCHAR2(255 CHAR),
    extensiones_permitidas  VARCHAR2(100 CHAR)
);
COMMENT ON TABLE tipos_evidencia IS 'Catalogo para los tipos de archivos de evidencia que se pueden subir.';

--52. EVIDENCIAS
CREATE TABLE evidencias (
    id_evidencia      NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
    id_tipo_evidencia NUMBER(10) NOT NULL,
    nombre_archivo    VARCHAR2(200 CHAR) NOT NULL,
    ruta_archivo      VARCHAR2(500 CHAR),
    tamanio_archivo    NUMBER(12), -- En bytes
    tipo_mime         VARCHAR2(100 CHAR),
    descripcion       VARCHAR2(255 CHAR),
    fecha_subida      TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    id_usuario        NUMBER(10) NOT NULL,
    id_metrica        NUMBER(10) NOT NULL, 
    CONSTRAINT fk_evid_tipoevid FOREIGN KEY (id_tipo_evidencia) REFERENCES tipos_evidencia(id_tipo_evidencia),
    CONSTRAINT fk_evid_usuario FOREIGN KEY (subido_por) REFERENCES usuarios(id_usuario),
